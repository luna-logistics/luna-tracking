...
export const EDITABLE_PAGES: EditablePage[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'no_account_note',  kind: 'text',     i18nKey: 'tracking.no_account_note',   labelFr: 'Note "sans inscription"', labelEn: '"No sign-up" note' },
      ...
      { key: 'map_alt',          kind: 'text',     i18nKey: 'tracking.map_alt',           labelFr: 'Carte — texte alternatif (accessibilité)', labelEn: 'Map — alt text (accessibility)' },
      { key: 'how_title',    kind: 'text',     i18nKey: 'tracking.how_title',   labelFr: 'Titre "comment suivre"', labelEn: 'How-to-track title' },
      { key: 'step1_title',  kind: 'text',     i18nKey: 'tracking.step1_title',  labelFr: 'Étape 1 (titre)', labelEn: 'Step 1 (title)' },
      { key: 'step1_body',   kind: 'textarea', i18nKey: 'tracking.step1_body',   labelFr: 'Étape 1 (texte)', labelEn: 'Step 1 (body)' },
      { key: 'step2_title',  kind: 'text',     i18nKey: 'tracking.step2_title',  labelFr: 'Étape 2 (titre)', labelEn: 'Step 2 (title)' },
      { key: 'step2_body',   kind: 'textarea', i18nKey: 'tracking.step2_body',   labelFr: 'Étape 2 (texte)', labelEn: 'Step 2 (body)' },
      { key: 'step3_title',  kind: 'text',     i18nKey: 'tracking.step3_title',  labelFr: 'Étape 3 (titre)', labelEn: 'Step 3 (title)' },
      { key: 'step3_body',   kind: 'textarea', i18nKey: 'tracking.step3_body',   labelFr: 'Étape 3 (texte)', labelEn: 'Step 3 (body)' },
      { key: 'step4_title',  kind: 'text',     i18nKey: 'tracking.step4_title',  labelFr: 'Étape 4 (titre)', labelEn: 'Step 4 (title)' },
      { key: 'step4_body',   kind: 'textarea', i18nKey: 'tracking.step4_body',   labelFr: 'Étape 4 (texte)', labelEn: 'Step 4 (body)' },
      { key: 'transparency_eyebrow', kind: 'text',     i18nKey: 'tracking.transparency_eyebrow', labelFr: 'Bloc transparence (sur-titre)', labelEn: 'Transparency block (eyebrow)' },
      { key: 'transparency_body',    kind: 'textarea', i18nKey: 'tracking.transparency_body',    labelFr: 'Bloc transparence (texte)', labelEn: 'Transparency block (body)' },
      { key: 'faq_title',  kind: 'text',     i18nKey: 'tracking.faq_title',  labelFr: 'Titre FAQ', labelEn: 'FAQ title' },
      { key: 'faq1_q',     kind: 'text',     i18nKey: 'tracking.faq1_q',     labelFr: 'FAQ 1 — question', labelEn: 'FAQ 1 — question' },
      { key: 'faq1_a',     kind: 'textarea', i18nKey: 'tracking.faq1_a',     labelFr: 'FAQ 1 — réponse',  labelEn: 'FAQ 1 — answer' },
      { key: 'faq2_q',     kind: 'text',     i18nKey: 'tracking.faq2_q',     labelFr: 'FAQ 2 — question', labelEn: 'FAQ 2 — question' },
      { key: 'faq2_a',     kind: 'textarea', i18nKey: 'tracking.faq2_a',     labelFr: 'FAQ 2 — réponse',  labelEn: 'FAQ 2 — answer' },
      { key: 'faq3_q',     kind: 'text',     i18nKey: 'tracking.faq3_q',     labelFr: 'FAQ 3 — question', labelEn: 'FAQ 3 — question' },
      { key: 'faq3_a',     kind: 'textarea', i18nKey: 'tracking.faq3_a',     labelFr: 'FAQ 3 — réponse',  labelEn: 'FAQ 3 — answer' },
      { key: 'faq4_q',     kind: 'text',     i18nKey: 'tracking.faq4_q',     labelFr: 'FAQ 4 — question', labelEn: 'FAQ 4 — question' },
      { key: 'faq4_a',     kind: 'textarea', i18nKey: 'tracking.faq4_a',     labelFr: 'FAQ 4 — réponse',  labelEn: 'FAQ 4 — answer' },
  ...
  },
  {
    ...
    fields: [
      { key: 'page_title', kind: 'text',     i18nKey: 'forwarding.page_title', labelFr: 'Titre principal (hero)', labelEn: 'Main title (hero)' },
      { key: 'intro',      kind: 'textarea', i18nKey: 'forwarding.intro',      labelFr: 'Texte d\'introduction (hero)', labelEn: 'Intro text (hero)' },
      { key: 'quoi_title', kind: 'text',     i18nKey: 'forwarding.quoi_title', labelFr: 'Titre "c\'est quoi"', labelEn: '"What is it" title' },
      { key: 'quoi_p1',    kind: 'textarea', i18nKey: 'forwarding.quoi_p1',    labelFr: '"C\'est quoi" — paragraphe 1', labelEn: '"What is it" — paragraph 1' },
      { key: 'quoi_p2',    kind: 'textarea', i18nKey: 'forwarding.quoi_p2',    labelFr: '"C\'est quoi" — paragraphe 2', labelEn: '"What is it" — paragraph 2' },
      { key: 'how_title',  kind: 'text',     i18nKey: 'forwarding.how_title',  labelFr: 'Titre "comment ça marche"', labelEn: 'How-it-works title' },
      { key: 'cases_title',  kind: 'text',     i18nKey: 'forwarding.cases_title',  labelFr: 'Titre "situations concrètes"', labelEn: 'Case studies title' },
      { key: 'cases_intro',  kind: 'textarea', i18nKey: 'forwarding.cases_intro',  labelFr: 'Intro "situations concrètes"', labelEn: 'Case studies intro' },
      { key: 'compare_title', kind: 'text',     i18nKey: 'forwarding.compare_title', labelFr: 'Titre "aérien ou maritime"', labelEn: 'Air-vs-sea title' },
      { key: 'compare_note',  kind: 'textarea', i18nKey: 'forwarding.compare_note',  labelFr: 'Note "aérien ou maritime"', labelEn: 'Air-vs-sea note' },
      { key: 'glossary_title', kind: 'text',    i18nKey: 'forwarding.glossary_title', labelFr: 'Titre glossaire', labelEn: 'Glossary title' },
      { key: 'refused_title',  kind: 'text',     i18nKey: 'forwarding.refused_title',  labelFr: 'Titre "ce que nous ne transportons pas"', labelEn: '"What we do not carry" title' },
      { key: 'refused_note',   kind: 'textarea', i18nKey: 'forwarding.refused_note',   labelFr: 'Note "ce que nous ne transportons pas"', labelEn: '"What we do not carry" note' },
      { key: 'space_title', kind: 'text',     i18nKey: 'forwarding.space_title', labelFr: 'Titre "espace Luna"', labelEn: '"Luna account" title' },
      { key: 'space_body',  kind: 'textarea', i18nKey: 'forwarding.space_body',  labelFr: 'Texte "espace Luna"', labelEn: '"Luna account" body' },
      { key: 'devis_title', kind: 'text',     i18nKey: 'forwarding.devis_title', labelFr: 'Titre "demander un devis"', labelEn: 'Quote form title' },
      { key: 'devis_intro', kind: 'textarea', i18nKey: 'forwarding.devis_intro', labelFr: 'Intro "demander un devis"', labelEn: 'Quote form intro' },
      { key: 'faq_title',     kind: 'text',     i18nKey: 'forwarding.faq_title',     labelFr: 'Titre FAQ', labelEn: 'FAQ title' },
      { key: 'contact_title', kind: 'text',     i18nKey: 'forwarding.contact_title', labelFr: 'Titre "nous parler"', labelEn: 'Contact title' },
      { key: 'contact_intro', kind: 'textarea', i18nKey: 'forwarding.contact_intro', labelFr: 'Intro "nous parler"', labelEn: 'Contact intro' },
