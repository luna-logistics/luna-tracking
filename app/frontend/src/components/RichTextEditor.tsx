...
export default function RichTextEditor({
  ...
  return (
    <div className="border-2 border-slate-300 rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-luna-cyan/40 focus-within:border-luna-cyan">
      {/* Prominent toolbar — bg-white with strong bottom border so it doesn't
          blend into the surrounding admin card. Icons keep their color; text
          labels appear on wider viewports for extra clarity. */}
      <div className="flex items-center gap-0.5 px-2 py-2 border-b-2 border-slate-200 bg-white flex-wrap shadow-sm">
        ...
        <label
          className="p-2 rounded hover:bg-slate-100 transition-colors text-luna-navy cursor-pointer inline-flex items-center relative"
